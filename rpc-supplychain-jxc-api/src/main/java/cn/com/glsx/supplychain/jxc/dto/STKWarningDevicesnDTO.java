...
public class STKWarningDevicesnDTO extends JXCMTBaseDTO implements Serializable{
	...
	@ApiModelProperty(name = "curMerchantName", notes = "当前所在商户名称", dataType = "string", required = false, example = "")
    ...
    @ApiModelProperty(name = "transferTime", notes = "滞留仓位入库时间", dataType = "string", required = false, example = "")
	...
	public String toString() {
		return "STKWarningDevicesnDTO [warningCode=" + warningCode + ", sn="
				+ sn + ", toMerchantCode=" + toMerchantCode
				+ ", toMerchantName=" + toMerchantName + ", curMerchantCode="
				+ curMerchantCode + ", curMerchantName=" + curMerchantName
				+ ", deviceType=" + deviceType + ", deviceTypeName="
				+ deviceTypeName + ", materialCode=" + materialCode
				+ ", materialName=" + materialName + ", activeTime="
				+ activeTime + ", sendTime=" + sendTime + ", transferTime="
				+ transferTime + ", unActiveDays=" + unActiveDays

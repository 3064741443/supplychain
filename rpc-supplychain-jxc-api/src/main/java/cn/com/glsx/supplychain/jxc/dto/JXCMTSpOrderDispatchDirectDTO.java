...
public class JXCMTSpOrderDispatchDirectDTO extends JXCMTBaseDTO implements Serializable{
	...
	public String toString() {
		return "JXCMTSpOrderDispatchDirectDTO [merchantOrder=" + merchantOrder

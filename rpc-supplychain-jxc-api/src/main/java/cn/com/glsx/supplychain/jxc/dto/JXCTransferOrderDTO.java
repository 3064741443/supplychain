 ...
 */
public class JXCTransferOrderDTO implements Serializable {
    ...
    @ApiModelProperty(name = "rebackReason", notes = "驳回原因", dataType = "String", required = true, example = "")

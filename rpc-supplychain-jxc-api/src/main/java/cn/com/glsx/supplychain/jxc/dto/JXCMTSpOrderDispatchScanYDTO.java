...
public class JXCMTSpOrderDispatchScanYDTO extends JXCMTBaseDTO implements Serializable{
	...
	public String toString() {
		return "JXCMTSpOrderDispatchScanYDTO [sendMerchantNo=" + sendMerchantNo

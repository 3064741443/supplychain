...
public class JXCMTOrderInfoQueryDTO implements Serializable{
	...
	public String toString() {
		return "JXCMTOrderInfoQueryDTO [merchantOrder=" + merchantOrder
				+ ", status=" + status + ", signStatus=" + signStatus
				+ ", channelId=" + channelId + ", orderTimeStart="
				+ orderTimeStart + ", orderTimeEnd=" + orderTimeEnd
				+ ", merchantName=" + merchantName + ", productTypeId="
				+ productTypeId + ", productName=" + productName

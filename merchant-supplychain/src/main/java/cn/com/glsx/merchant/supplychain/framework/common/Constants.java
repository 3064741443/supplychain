package cn.com.glsx.merchant.supplychain.framework.common;
...
public final class Constants {
    ...
    public final static String CONTEXT_PATH_VALUE = "ggs.evn.webapp";
    ...
    public static final String IMPORT_DD_INSURANCENUMBER = "4"; //迪迪保单号管理导入
     ...
     * 区域、省份、店面
     */
    public static final int DIMENSION_REGION = 1;
    public static final int DIMENSION_PROVINCE = 2;
    public static final int DIMENSION_SHOPNAME = 3;


    /**
     * 客户种类：1 个人客户(身份证) 2公司客户(组织机构代码证),3个人客户(港澳返乡证),4个人客户(台胞证)
     */
    public static final int CUSTOMERTYPE_PERSONAL = 1;
    public static final int CUSTOMERTYPE_COMPANY = 2;
    public static final int CUSTOMERTYPE_HONGKONG_MACAO = 3;
    public static final int CUSTOMERTYPE_TAIWAN = 4;

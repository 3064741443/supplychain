...
public class ExcelXlsxStreamingViewUtil extends AbstractXlsxStreamingView {
    ...
    {  	
    	if(propertyName.equals("totalOrder"))
    	{
    		return true;
    	}
    	if(propertyName.equals("totalCheck"))
    	{
    		return true;
    	}
    	if(propertyName.equals("totalSends"))
    	{
    		return true;
    	}
    	if(propertyName.equals("totalOwes"))
    	{
    		return true;
    	}
    	if(propertyName.equals("acceptQuantity"))
    	{
    		return true;
    	}
        return false;

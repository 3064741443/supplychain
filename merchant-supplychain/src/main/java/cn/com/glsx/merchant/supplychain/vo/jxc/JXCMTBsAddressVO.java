...
public class JXCMTBsAddressVO implements Serializable{
	@ApiModelProperty(name = "id", notes = "选填 地址id", dataType = "int", required = false, example = "3")
	private Integer id;
	...
	public String toString() {
		return "JXCMTBsAddressVO [id=" + id + ", name=" + name + ", mobile="

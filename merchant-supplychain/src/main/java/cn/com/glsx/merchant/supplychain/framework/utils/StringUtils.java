 ...
 *
 */
package cn.com.glsx.merchant.supplychain.framework.utils;
...
public class StringUtils extends org.apache.commons.lang.StringUtils {
    ...
    public static String trimFirstAndLastChar(String source,char element){
        ...
        if (isNotEmpty(source) && source.length() > 0) {
            do{
...
//        System.out.println("aaaaaaaaaaaaa:"+ StringUtils.replaceCharSplitStr("2", "2", ","));
          System.out.println("aaaaaaaaaaaaa:"+ StringUtils.trimFirstAndLastChar(null,'\''));
    }
}

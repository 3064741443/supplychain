...
public class BsMerchantOrderBssVo implements Serializable{
    ...
    //物流信息
    private List<BsLogisticsVo> listLogistics;
	...
	public List<BsLogisticsVo> getListLogistics() {
		return listLogistics;
	}
	public void setListLogistics(List<BsLogisticsVo> listLogistics) {
		this.listLogistics = listLogistics;
	}

	@Override
	public String toString() {
		return "BsMerchantOrderBssVo{" +

...
@Component
public class ExcelXlsxStreamingViewSalesMerchantOrder{
...
//        cellStyle.setFont(cellFont);
    ...
    private boolean isMoneyFomatCell(String propertyName)
    {
    	...
    	if(propertyName.equals("totalAmount"))
    	{
    		return true;
    	}
    	return false;
    ...
    private boolean isNumFormatCell(String propertyName)
    {
    	...
    	if(propertyName.equals("orderQuantity"))
    	{
    		return true;
    	}
    	if(propertyName.equals("checkQuantity"))
    	{
    		return true;
    	}
    	if(propertyName.equals("alreadyShipmentQuantity"))
    	{
    		return true;
    	}
    	if(propertyName.equals("signQuantity"))
    	{
    		return true;
    	}
    	if(propertyName.equals("oweQuantity"))
    	{
    		return true;
    	}
    	return false;
    ...
    public void buildExcelDocument(Map<String, Object> model,
        ...
        String excelTemplateFilePath = model.getOrDefault(EXCEL_TEMPLATE_FILE_PATH_KEY,"/templates/templateMerchantOrder.xlsx").toString();
            ...
            for (int i = 0; i < objs.size(); i++) {
                ...
                for (int columnIndex = 0; columnIndex < propertyColumns.length; columnIndex++) {
                  ...
                  //单元格格式设置
	                ...
	                else if(this.isMoneyFomatCell(propertyColumns[columnIndex]))
	                {
	                	DataFormat format = xssfWorkbook.createDataFormat();
                    	...
                    	String strValue = df.format(Double.parseDouble(cellValue));

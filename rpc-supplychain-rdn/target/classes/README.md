...
# dubbo配置
# dubbo应用名称
ore.dubbo.application.name=rpc-supplychain-rdn
# dubbo应用所有者
...
# dubbo服务扫描包路径
ore.dubbo.scan=cn.com.glsx.rpc.supplychain.rdn.remote
# dubbo自定义过滤器配置
ore.dubbo.provider.enabled=true
...
# mybatis配置
# 实体模型包
mybatis.type-aliases-package=cn.com.glsx.rpc.supplychain.rdn.model
# SQL脚本文件路径

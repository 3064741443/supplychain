...
public class EcMerchantOrder implements Serializable {
	...
	public String toString() {
		return "EcMerchantOrder [id=" + id + ", channel=" + channel
				+ ", merchantCode=" + merchantCode + ", merchantName="
				+ merchantName + ", orderNumber=" + orderNumber
				+ ", productName=" + productName + ", productCode="
				+ productCode + ", deviceType=" + deviceType + ", price="
				+ price + ", orderQuantity=" + orderQuantity
				+ ", checkQuantity=" + checkQuantity + ", dispatchOrderNumber="
				...
				+ ", productRemarks=" + productRemarks + ", orderRemark="
				+ orderRemark + ", checkRemark=" + checkRemark + ", checkBy="
				+ checkBy + ", checkTime=" + checkTime + ", status=" + status
				...
				+ ", materialName=" + materialName + ", logisticsDesc="
				+ logisticsDesc + ", signStatus=" + signStatus
				...
				+ ", productTotal=" + productTotal + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", checkStartDate=" + checkStartDate
				+ ", checkEndDate=" + checkEndDate + ", dealerUserName="
				+ dealerUserName + "]";
	}

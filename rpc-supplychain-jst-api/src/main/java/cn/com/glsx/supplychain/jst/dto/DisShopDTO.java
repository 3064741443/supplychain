...
public class DisShopDTO extends BaseDTO implements Serializable{
    ...
    private List<JstShopDTO> listShopDto;
	...
	public List<JstShopDTO> getListShopDto() {
		return listShopDto;
	}

	public void setListShopDto(List<JstShopDTO> listShopDto) {
		this.listShopDto = listShopDto;
	}
	...
	public String toString() {
		return "DisShopDTO [shopCode=" + shopCode + ", shopName=" + shopName
				...
				+ ", agentMerchantName=" + agentMerchantName + ", listShopDto="
				+ listShopDto + ", pageSize=" + pageSize + ", pageNo=" + pageNo
				+ "]";
	}

(function(angular) {
    function jiabaowuyouPutInHouseDefine($scope, wuyouService, comService, $uibModalInstance, SweetAlertX,FileUploader,param) {
        ...
        $scope.downloadTemplate = function() {
            var path = omssupplychainAdminHost+"statementSellInfo/statementSellJbwyDownloadTemplate";
            location.href =path;
        };

        var uploaderDeviceList = $scope.uploaderJbwyList = new FileUploader({
            url : omssupplychainAdminHost+"statementSellInfo/statementSellJbwyImportDataCheck",
        ...
        $scope.uploaderJbwyList.onBeforeUploadItem = function (fileItem) {
            $scope.importLoadShow = true;
        };
        // 上传控件：回调响应：
        $scope.uploaderJbwyList.onCompleteItem = function(item, response, status, headers) {
            $scope.importLoadShow = false;
        ...
        $scope.importJbwyList = function(status) {
            if ($scope.outerForm.$valid) {
                if(importStatementCollection=="" || importStatementCollection == null || importStatementCollection == "null"){
                    ...
                    var Data = {
                        ...
                        listStatementSellJbwyImport:importStatementCollection
                    };
                    
                    wuyouService.statementSellJbwyImport(Data, function(data) {
    ...
    angular.module('reconciliationSplitMana').controller('jiabaowuyouPutInHouseDefine', jiabaowuyouPutInHouseDefine);
})(angular);
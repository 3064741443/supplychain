angular.module(businessSettlementMana, ['ngResource'])
...
}]).factory('cusOrderService', ['$resource', function ($resource) {
    return $resource('json/service.json', null, {
        getList: {
            url: omssupplychainAdminHost + 'gh/listProductConfigs',
            // url: 'views/businessSettlementMana/customerOrder/json/cusOrderTable.json',
            method: 'POST',
            isArray: false
        },
        listParentBrands: {
            url: omssupplychainAdminHost + 'gh/listParentBrands',
            method: 'POST',
            isArray: false
        },
        listSubBrands: {
            url: omssupplychainAdminHost + 'gh/listSubBrands',
            method: 'POST',
            isArray: false
        },
        listAudis: {
            url: omssupplychainAdminHost + 'gh/listAudis',
            method: 'POST',
            isArray: false
        },
        listMotorcyle: {
            url: omssupplychainAdminHost + 'gh/listMotorcyle',
            method: 'POST',
            isArray: false
        },
        listCategorys: {

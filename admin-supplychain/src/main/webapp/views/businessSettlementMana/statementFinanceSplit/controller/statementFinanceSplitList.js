(function (angular) {
    function statementFinanceSplitCtrl($scope, DTOptionsBuilder, statementFinanceSplitService, commonService, DTColumnBuilder, common, SweetAlertX, $filter, $uibModal) {
        ...
        $scope.dtInstance = {
            serverData: function (param) {
                return statementFinanceSplitService.listStatementFinanceSplit(param, function (response) {
...
*/
        ...
        $scope.search = function () {
            ...
            var data = {
                condition: {
                    ...
                    combileCode: $scope.formData.combileCode,
                    startDate : startDate,
                    endDate : endDate
                }
            };
    ...
    // angular.module(businessSettlementMana).controller('statementFinanceSplitCtrl', statementFinanceSplitCtrl);
    angular.module(reconciliationSplitMana).controller('statementFinanceSplitCtrl', statementFinanceSplitCtrl);
})(angular);

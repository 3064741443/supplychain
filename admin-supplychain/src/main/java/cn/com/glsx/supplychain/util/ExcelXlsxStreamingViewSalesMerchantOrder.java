...
@Component
public class ExcelXlsxStreamingViewSalesMerchantOrder extends AbstractXlsxStreamingView {
    ...
    private boolean isMoneyFomatCell(String propertyName)
    {
        ...
        return propertyName.equals("totalAmount");
    }
    ...
    {  	
        ...
        return propertyName.equals("oweQuantity");
    }

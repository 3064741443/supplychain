...
@Component
public class ExcelXlsxStreamingViewDeInit extends AbstractXlsxStreamingView {
    ...
    public void buildExcelDocument(Map<String, Object> model,
        ...
        String excelTemplateFilePath = model.getOrDefault(EXCEL_TEMPLATE_FILE_PATH_KEY,"/templates/templateDeviceInit.xlsx").toString();

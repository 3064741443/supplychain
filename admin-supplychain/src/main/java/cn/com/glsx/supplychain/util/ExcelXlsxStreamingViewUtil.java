...
@Component
public class ExcelXlsxStreamingViewUtil extends AbstractXlsxStreamingView {
            ...
            for (int i = 0; i < objs.size(); i++) {
               ...
               //     newCell.setCellType(HSSFCell.CELL_TYPE_STRING);
                    ...
                    if(this.isNumFormatCell(propertyColumns[columnIndex]))
                    {
                    	...
                    	if(!SupplychainUtils.parseInt(cellValue))
                    	{
                    		cellValue = "0";
                    	}    
                    ...
                    else if(this.isMoneyFomatCell(propertyColumns[columnIndex]))
                    {
                    	...
                    	newCell.setCellStyle(cellStyle); 
                    	if(!SupplychainUtils.parseDouble(cellValue))
                    	{
                    		cellValue = "0";
                    	}                 	

...
@Component
public class ExcelXlsxStreamingViewStatementFinanceSplit extends AbstractXlsxStreamingView {
     ...
     * @return
     */
  /*  private String[] fetchTitleColumns(XSSFWorkbook workbook){
    	//获得模板sheet
        Sheet sheetTemplate = workbook.getSheetAt(0);
        //获取标题行，rowIndex=1代表第二行
        Row headRow = sheetTemplate.getRow(1);   
        //获取标题行的列数
    ...
    public void buildExcelDocument(Map<String, Object> model,
        ...
        String excelTemplateFilePath = model.getOrDefault(EXCEL_TEMPLATE_FILE_PATH_KEY,"/templates/templateStatementFinanceSplitExport.xlsx").toString();
    ...
    //    String[] headColumns = fetchTitleColumns(xssfWorkbook);

...
@Component
public class ExcelXlsxStreamingViewStatementAccountJR extends AbstractXlsxStreamingView{
    ...
    public void buildExcelDocument(Map<String, Object> model,
        ...
        String fileName = model.getOrDefault(EXCEL_FILE_NAME_KEY, Constants.EXPORT_FORMAT_STATEMENT_ACCOUNT_JR).toString();
        String excelTemplateFilePath = model.getOrDefault(EXCEL_TEMPLATE_FILE_PATH_KEY, Constants.EXPORT_FOLDER_STATEMENT_ACCOUNT_JR).toString();
        String sheetName = model.getOrDefault(EXCEL_SHEET_NAME_KEY, Constants.EXPORT_NAME_STATEMENT_ACCOUNT_JR).toString();

...
public class JXCMTBsMerchantOrderBssExcelVo implements Serializable{
	...
	@ExcelResources(title = "审核备注",order = 16)
	...
	@ExcelResources(title = "项目",order = 19)
	...
	@ExcelResources(title = "是否投保",order = 20)
	...
	@ExcelResources(title = "订购数量",order = 11)
	...
	@ExcelResources(title = "审核数量",order = 12)
	...
	@ExcelResources(title = "已发数量",order = 13)
	...
	@ExcelResources(title = "欠货数量",order = 14)
	...
	@ExcelResources(title = "车辆信息",order = 15)
	...
	@ExcelResources(title = "物流信息",order = 18)
	...
	@ExcelResources(title = "发货时间",order = 17)

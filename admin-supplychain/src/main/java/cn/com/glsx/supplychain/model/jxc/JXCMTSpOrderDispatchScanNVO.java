...
public class JXCMTSpOrderDispatchScanNVO implements Serializable{
	...
	public String toString() {
		return "JXCMTSpOrderDispatchScanNVO [sendMerchantNo=" + sendMerchantNo
				...
				+ ", batchOption=" + batchOption + ", listOrderWarehouseVo="
				+ listOrderWarehouseVo + "]";
	}

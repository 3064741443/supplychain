...
public class JXCMTSpOrderDispatchScanYVO implements Serializable{
	...
	@ApiModelProperty(name = "deviceId", notes = "设备小类", dataType = "int", required = true, example = "")
    private Integer deviceId;
	@ApiModelProperty(name = "deviceName", notes = "设备小类名称", dataType = "string", required = true, example = "")
	...
	@ApiModelProperty(name = "remark", notes = "备注(选填)批量不填", dataType = "string", required = false, example = "")
	...
	@ApiModelProperty(name = "listOrderWarehouseVo", notes = "商户子订单对应仓库id", dataType = "string", required = true, example = "")
	List<JXCMTSpOrderWarehouseVO> listOrderWarehouseVo;
	...
	public List<JXCMTSpOrderWarehouseVO> getListOrderWarehouseVo() {
		return listOrderWarehouseVo;
	}
	public void setListOrderWarehouseVo(
			List<JXCMTSpOrderWarehouseVO> listOrderWarehouseVo) {
		this.listOrderWarehouseVo = listOrderWarehouseVo;
	}
	...
	public String toString() {
		return "JXCMTSpOrderDispatchScanYVO [sendMerchantNo=" + sendMerchantNo
				+ ", sendMerchantName=" + sendMerchantName + ", deviceId="
				+ deviceId + ", deviceName=" + deviceName + ", packageOne="
				+ packageOne + ", materialCode=" + materialCode
				+ ", materialName=" + materialName + ", address=" + address
				+ ", contacts=" + contacts + ", mobile=" + mobile + ", remark="
				+ remark + ", batchOption=" + batchOption
				+ ", listOrderWarehouseVo=" + listOrderWarehouseVo + "]";
	}

...
@Table(name = "am_statement_finance_combile")
public class StatementFinanceCombile implements Serializable{
	@Id
    private Long id;
    ...
    public String toString() {
        return "StatementFinanceCombile{" +
                "id=" + id +
                ", combileCode='" + combileCode + '\'' +
                ...
                ", financeCustomerCode='" + financeCustomerCode + '\'' +
                ", workType='" + workType + '\'' +
                ", workOrder='" + workOrder + '\'' +
                ", startDate=" + startDate +
                ", endDate=" + endDate +

...
/**
 * @ClassName StatementCollectionSplit 对账单-广汇采集(拆分)
 * @Author admin
 * @Param
 * @Date 2019/9/12 14:32
 * @Version
 **/
@Table(name = "am_statement_collection_split")
public class StatementCollectionSplit implements Serializable {
    /**
     * id
     */
    private Long id;
    ...
    public String toString() {
        return "StatementCollectionSplit{" +
                "id=" + id +
